...
// This function is no longer needed with pure Supabase auth
// but keeping for backward compatibility if used elsewhere
export function parseUserData(userData: any): UserData | null {
  try {
    return userData;
  } catch (error) {
